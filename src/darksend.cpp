...
/* *** BEGIN DARKSEND MAGIC - NOBLE **********
    Copyright (c) 2014-2015, Noble Developers
        eduffield - evan@noblepay.io
        udjinm6   - udjinm6@noblepay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Noble and make it unusable. To
