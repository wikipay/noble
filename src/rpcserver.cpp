...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Noble features */
    { "noble",               "masternode",             &masternode,             true,      true,       false },
    { "noble",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "noble",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "noble",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "noble",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "noble",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "noble",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "noble",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use nobled, or the -server option to noble-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> noble-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9448/\n";
}
