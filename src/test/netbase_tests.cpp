...
// Copyright (c) 2014-2015 The Noble Core developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:9449", "127.0.0.1", 9449));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9449", "127.0.0.1", 9449));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9449", "::ffff:127.0.0.1", 9449));
    BOOST_CHECK(TestSplitHost("[::]:9449", "::", 9449));
    BOOST_CHECK(TestSplitHost("::9449", "::9449", -1));
    BOOST_CHECK(TestSplitHost(":9449", "", 9449));
    BOOST_CHECK(TestSplitHost("[]:9449", "", 9449));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9449", "127.0.0.1:9449"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9449", "[::]:9449"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
