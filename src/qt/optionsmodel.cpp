...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NOBLE);
    ...
    if (settings.contains("nAnonymizeDarkcoinAmount"))
        SoftSetArg("-anonymizenobleamount", settings.value("nAnonymizeDarkcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in noble.cpp during shotdown to also remove the window positions
