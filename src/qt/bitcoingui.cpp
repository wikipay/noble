    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Noble Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Noble address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and noble: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Noble Core"), this);
    aboutAction->setStatusTip(tr("Show information about Noble Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Noble"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Noble addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Noble addresses"));
    ...
    openAction->setStatusTip(tr("Open a noble: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Noble Core help message to get a list with possible Noble command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Noble Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Noble network", "", count));
}
...
{
    QString strTitle = tr("Noble Core"); // default title
