...
Only requiring some minor changes is noble.cpp.
...
Changes to noble.cpp
----------------------
noble.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
