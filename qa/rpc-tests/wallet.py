...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 NOBLE, node2 has none. 
#   d) node0 sends 21 NOBLE to node2, in two transactions (11 NOBLE, then 10 NOBLE).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 NOBLE from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 NOBLE in block rewards plus fees, but
