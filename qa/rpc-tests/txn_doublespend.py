...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 NOBLE:
        ...
        # Node0's balance should be starting balance, plus 500 NOBLE for another
        ...
        # Node0's total balance should be starting balance, plus 1000 NOBLE for 
