...
RESOURCES += src/qt/noble.qrc src/qt/noble_locale.qrc
TRANSLATIONS += src/qt/locale/noble_bg.ts \
                src/qt/locale/noble_de.ts \
                src/qt/locale/noble_en.ts \
                src/qt/locale/noble_es.ts \
                src/qt/locale/noble_fi.ts \
                src/qt/locale/noble_fr.ts \
                src/qt/locale/noble_it.ts \
                src/qt/locale/noble_ja.ts \
                src/qt/locale/noble_pl.ts \
                src/qt/locale/noble_pt.ts \
                src/qt/locale/noble_ru.ts \
                src/qt/locale/noble_sk.ts \
                src/qt/locale/noble_sv.ts \
                src/qt/locale/noble_vi.ts \
                src/qt/locale/noble_zh_CN.ts \
                src/qt/locale/noble_zh_TW.ts
